...
internal static class MTLFormats
{
    ...
    internal static MTLPixelFormat GetMTLPixelFormat(PixelFormat format)
    {
        return format switch
        {
            ...
            PixelFormat.R8G8B8A8UNormSRgb => MTLPixelFormat.RGBA8UnormsRGB,
            ...
            PixelFormat.B8G8R8A8UNormSRgb => MTLPixelFormat.BGRA8UnormsRGB,
            PixelFormat.BC1UNorm => MTLPixelFormat.BC1RGBA,
            PixelFormat.BC1UNormSRgb => MTLPixelFormat.BC1RGBAsRGB,
            PixelFormat.BC2UNorm => MTLPixelFormat.BC2RGBA,
            PixelFormat.BC2UNormSRgb => MTLPixelFormat.BC2RGBAsRGB,
            PixelFormat.BC3UNorm => MTLPixelFormat.BC3RGBA,
            PixelFormat.BC3UNormSRgb => MTLPixelFormat.BC3RGBAsRGB,
