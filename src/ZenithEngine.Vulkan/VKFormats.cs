...
internal unsafe class VKFormats
{
    ...
    public static Format GetPixelFormat(PixelFormat format)
    {
        return format switch
        {
            ...
            _ => throw new ZenithEngineException(ZenithEngineException.NotSupported(format))
        };
    }
    ...
    public static SampleCountFlags GetSampleCountFlags(TextureSampleCount count)
    {
        return count switch
        {
            ...
            _ => throw new ZenithEngineException(ZenithEngineException.NotSupported(count))
        };
    }
                                 ...
                                 out SamplerMipmapMode mode)
    {
        switch (filter)
        {
            ...
            case SamplerFilter.Anisotropic:
                ...
                break;
            default:
                throw new ZenithEngineException(ZenithEngineException.NotSupported(filter));
        }
    }
    ...
    public static SamplerAddressMode GetSamplerAddressMode(AddressMode mode)
    {
        return mode switch
        {
            ...
            _ => throw new ZenithEngineException(ZenithEngineException.NotSupported(mode))
        };
    }
    ...
    public static CompareOp GetCompareOp(ComparisonFunction function)
    {
        return function switch
        {
            ...
            _ => throw new ZenithEngineException(ZenithEngineException.NotSupported(function))
        };
    }
    ...
    public static BorderColor GetBorderColor(SamplerBorderColor color)
    {
        return color switch
        {
            ...
            _ => throw new ZenithEngineException(ZenithEngineException.NotSupported(color))
        };
    }
    ...
    public static VkFrontFace GetFrontFace(FrontFace face)
    {
        return face switch
        {
            ...
            _ => throw new ZenithEngineException(ZenithEngineException.NotSupported(face))
        };
    }
    ...
    public static StencilOp GetStencilOp(StencilOperation operation)
    {
        return operation switch
        {
            ...
            _ => throw new ZenithEngineException(ZenithEngineException.NotSupported(operation))
        };
    }
    ...
    public static BlendFactor GetBlendFactor(Blend blend)
    {
        return blend switch
        {
            ...
            _ => throw new ZenithEngineException(ZenithEngineException.NotSupported(blend))
        };
    }
    ...
    public static VkPrimitiveTopology GetPrimitiveTopology(PrimitiveTopology topology)
    {
        return topology switch
        {
            ...
            _ => throw new ZenithEngineException(ZenithEngineException.NotSupported(topology))
        };
    }
